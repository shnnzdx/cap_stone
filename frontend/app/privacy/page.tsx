...
export default function Privacy() {
  return <main><Header />
    <section className="subhero shell"><p className="eyebrow">PRODUCT PRIVACY</p><h1>Your preferences.<br/>Your choice.</h1><p>Choose what the group can see while still giving TripSync the context needed to shape a workable plan.</p><Link className="button dark" href="/signup?next=/trips/new">Create a trip</Link></section>
