...
export default function FAQ() {
  return <main><Header />
    <section className="subhero shell"><p className="eyebrow">FAQ</p><h1>Questions, answered.</h1><p>Clear answers about privacy, group decisions, flexibility, and travel information.</p></section>
